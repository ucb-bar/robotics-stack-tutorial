...
`lab.start()` in the notebook (or `mb start maxpool2d_s8` in a terminal) puts the unoptimized kernel here, as
**`maxpool2d_s8.c`**. Its header has the rules and four hints, one at a time.
